...
> ساخته‌شده به‌صورت **خودکار** در 2026-09-23 09:49 UTC — دستی ویرایش نکن.
> منبع: `inventory.json` + `runs.jsonl` · تعدادِ اجراهای ثبت‌شده: **1**
...
> _نمودارِ «مشکلاتِ باز در هر اجرا» بعد از دومین اجرا ساخته می‌شود._

### پوششِ تست

> _نمودارِ «تعدادِ تست‌های سبز» بعد از دومین اجرا ساخته می‌شود._
...
> _نمودارِ «تعدادِ مسیرهای API» بعد از دومین اجرا ساخته می‌شود._
