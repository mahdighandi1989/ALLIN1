...
app.include_router(letter_ai_router.router, prefix="/api/letter-ai", tags=["letter-ai"])
...
app.include_router(policy_inbox_router.router, prefix="/api/policy-inbox", tags=["policy-inbox"])
...
app.include_router(charge_tariff_router.router, prefix="/api/charge-tariff", tags=["charge-tariff"])
