...
class FacilityBase(BaseModel):
    ...
    amount: Decimal = Field(..., gt=0, max_digits=18, decimal_places=2, description="Facility amount")
    currency: str = Field(default="AED", min_length=3, max_length=10, description="Currency code")
    outstanding: Optional[Decimal] = Field(None, ge=0, max_digits=18, decimal_places=2, description="Outstanding amount")
    ...
    interest_rate: Optional[Decimal] = Field(None, ge=0, le=100, max_digits=5, decimal_places=2, description="Interest rate percentage")
...
class FacilityUpdate(BaseModel):
    ...
    name: Optional[str] = Field(None, max_length=200, description="Facility name")
    amount: Optional[Decimal] = Field(None, gt=0, max_digits=18, decimal_places=2, description="Facility amount")
