...
from app.models.kb import KnowledgeTopic, KnowledgeEntry  # noqa: F401  (register for create_all)
from app.models.profile_entities import PropertyEvent  # noqa: F401  (register for create_all)
