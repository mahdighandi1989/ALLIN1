...
updated_at: '2026-06-07T22:08:45.445260+00:00'
target_files:
...
1. فرم ایجاد/ویرایش دستی مشتری، نام‌هایی حاوی اعداد یا کاراکترهای خاص (مانند `!@#$`) را رد می‌کند. _(verify: ui_interaction)_
2. فرم ایجاد/ویرایش دستی مشتری، شماره تلفن‌ها را در برابر فرمت E.164 اعتبارسنجی می‌کند. _(verify: ui_interaction)_
3. فرم ایجاد/ویرایش دستی تسهیلات، `end_date` را بعد از `start_date` اعتبارسنجی می‌کند. _(verify: ui_interaction)_
4. پیام‌های خطای اعتبارسنجی سمت کلاینت واضح و مفید هستند. _(verify: manual_only)_
