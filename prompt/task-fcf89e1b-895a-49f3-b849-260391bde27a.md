...
updated_at: '2026-06-07T16:59:01.572188+00:00'
target_files:
...
1. مشخص شد endpoint `POST /{entity}/{item_id}/restore` در کدام دسته است (orphan/internal/deprecated) _(verify: static)_
