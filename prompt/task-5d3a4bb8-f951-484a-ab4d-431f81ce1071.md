---
task_id: 5d3a4bb8-f951-484a-ab4d-431f81ce1071
title: 'endpoint بک‌اند بلااستفاده: POST /verify'
type: audit
priority: medium
...
created_at: '2026-06-07T16:59:00.706198+00:00'
updated_at: '2026-06-07T22:09:55.293953+00:00'
target_files:
- backend/app/routers/auth.py
---

# endpoint بک‌اند بلااستفاده: POST /verify
...
- [ ] مشخص شد endpoint `POST /verify` در کدام دسته است (orphan/internal/deprecated)
...
1. گام ۱: grep روی `/verify` در frontend + scripts/ + docs/ — اگر caller هست، اتصال را drop شده اصلاح کن.
...
1. مشخص شد endpoint `POST /verify` در کدام دسته است (orphan/internal/deprecated) _(verify: manual_only)_
