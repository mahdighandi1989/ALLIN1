...
updated_at: '2026-06-07T16:56:38.930809+00:00'
target_files:
...
2. `FacilityFormModal` should store and display multiple validation errors simultaneously. _(verify: static)_
3. Error messages should appear next to their corresponding input fields. _(verify: static)_
4. A generic toast message should indicate form errors, with details shown on fields. _(verify: static)_
