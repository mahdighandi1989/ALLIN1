...
updated_at: '2026-06-07T16:54:34.143153+00:00'
target_files:
...
1. تمام درخواست‌های HTTP خارجی در بک‌اند دارای تایم‌اوت صریح پیکربندی شده باشند.
2. یک تست (واحد یا یکپارچه‌سازی) تأیید کند که فراخوانی‌های خارجی به تایم‌اوت پیکربندی شده احترام می‌گذارند.
