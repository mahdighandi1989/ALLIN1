---
task_id: 198395d5-7cd5-4f3e-b3c7-17ad757d39ab
title: بروزرسانی تست‌های offer_letter با تغییرات مدل
...
created_at: '2026-05-31T16:21:40.110886+00:00'
updated_at: '2026-06-05T15:53:09.547619+00:00'
archived: true
archived_at: '2026-06-05T15:53:09.547619+00:00'
tags:
- merged
target_files:
...
# بروزرسانی تست‌های offer_letter با تغییرات مدل
...
---
[scan #2 at 2026-05-31T16:21:40.359257+00:00]
## 📋 شرح
یک فایل اخیراً تغییر کرده و این فایل (dependent) به آن وابسته است. بدون بررسی، احتمال silent regression وجود دارد.
...
- 📝 reas
---
[scan #3 at 2026-05-31T16:21:40.479900+00:00]
## 📋 شرح
یک فایل اخیراً تغییر کرده و این فایل (dependent) به آن وابسته است. بدون بررسی، احتمال silent regression وجود دارد.
...
- 📝 reaso
---
[scan #4 at 2026-05-31T16:21:40.891749+00:00]
## 📋 شرح
یک فایل اخیراً تغییر کرده و این فایل (dependent) به آن وابسته است. بدون بررسی، احتمال silent regression وجود دارد.

## 🔍 جزئیات
- 📂 فایل تغییریافته: `backend/app/main.py`
- 📂 فایل وابسته (نیازمند بررسی): `backend/tests/test_main.py`
- 🔥 risk level: **high**
- 📝 reason: This test file is exp
---
[scan #5 at 2026-05-31T16:21:41.023058+00:00]
## 📋 شرح
یک فایل اخیراً تغییر کرده و این فایل (dependent) به آن وابسته است. بدون بررسی، احتمال silent regression وجود دارد.

## 🔍 جزئیات
- 📂 فایل تغییریافته: `backend/app/models/__init__.py`
- 📂 فایل وابسته (نیازمند بررسی): `backend/tests/test_offer_letter.py`
- 🔥 risk level: **high**
- 📝 reason: فا
