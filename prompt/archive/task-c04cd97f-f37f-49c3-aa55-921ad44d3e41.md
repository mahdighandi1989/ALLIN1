---
task_id: c04cd97f-f37f-49c3-aa55-921ad44d3e41
title: 'تعیین تکلیف endpoint بلااستفاده: POST /{notification_id}/read'
type: audit
priority: medium
...
created_at: '2026-05-31T16:21:49.063243+00:00'
...
# تعیین تکلیف endpoint بلااستفاده: POST /{notification_id}/read
...
1. مشخص شد endpoint `POST /{notification_id}/read` در کدام دسته است (orphan/internal/deprecated) _(verify: manual_only)_
