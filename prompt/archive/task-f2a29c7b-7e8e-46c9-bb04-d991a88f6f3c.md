---
task_id: f2a29c7b-7e8e-46c9-bb04-d991a88f6f3c
title: 'تعیین تکلیف endpoint بلااستفاده: POST /register'
type: audit
priority: medium
...
created_at: '2026-05-31T16:21:46.335286+00:00'
...
# تعیین تکلیف endpoint بلااستفاده: POST /register
...
---
[scan #2 at 2026-05-31T16:21:46.590260+00:00]
## 📋 شرح
endpoint `POST /verify` در `backend/app/routers/auth.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
