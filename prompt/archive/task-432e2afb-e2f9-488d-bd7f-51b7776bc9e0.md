---
task_id: 432e2afb-e2f9-488d-bd7f-51b7776bc9e0
title: رسیدگی به endpoint بلااستفاده GET /metrics
type: audit
priority: medium
...
created_at: '2026-05-31T16:21:46.068983+00:00'
...
# رسیدگی به endpoint بلااستفاده GET /metrics
...
---
[scan #2 at 2026-05-31T16:21:46.334983+00:00]
## 📋 شرح
endpoint `GET /api/simulate-unhandled-error` در `backend/app/main.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.

## 🔍 جزئیات
- method: `GET`
- path: `/api/simulate-unhandled-error`
- فایل: `backend/app/main.py`
- علت: no frontend fetch + no rece
...
1. مشخص شد endpoint `GET /metrics` در کدام دسته است (orphan/internal/deprecated) _(verify: manual_only)_
