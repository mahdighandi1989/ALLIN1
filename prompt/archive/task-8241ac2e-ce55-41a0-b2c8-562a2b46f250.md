---
task_id: 8241ac2e-ce55-41a0-b2c8-562a2b46f250
title: یکپارچه‌سازی default فیلد 'finally'
type: bug_fix
priority: high
...
created_at: '2026-05-31T16:20:28.964045+00:00'
...
# یکپارچه‌سازی default فیلد 'finally'
...
---
[scan #2 at 2026-05-31T16:20:29.197690+00:00]
## 📋 شرح
...
## 🔍 جزئیات
- علت: field else has different defaults: ['datetime.now(timezone.utc) + timedelta(minutes=
---
[scan #3 at 2026-05-31T16:20:29.316952+00:00]
## 📋 شرح
...
## 🔍 جزئیات
- علت: field user_id has different defaults: ['None) -> str:', 'None', 'payload.get("use
---
[scan #4 at 2026-05-31T16:20:29.434888+00:00]
## 📋 شرح
...
---
[scan #5 at 2026-05-31T16:20:29.554769+00:00]
## 📋 شرح
...
## 🔍 جزئیات
- علت: field grace_period_months has different defaults: ['Field(None, ge=0,
---
[scan #6 at 2026-05-31T16:20:29.678896+00:00]
## 📋 شرح
...
## 🔍 جزئیات
- علت: field action has different defaults: ['None,', 'Query(None),', 'None']
...
1. `finally` در همه‌جا از یک منبع default می‌گیرد _(verify: static)_
