---
task_id: 4faeeac0-19f1-4d74-b6c6-4c01e3d282e8
title: 'تعیین تکلیف endpoint بلااستفاده: POST /{entity}/{item_id}/restore'
type: audit
priority: medium
...
created_at: '2026-05-31T16:21:50.604867+00:00'
...
# تعیین تکلیف endpoint بلااستفاده: POST /{entity}/{item_id}/restore
...
1. مشخص شد endpoint `POST /{entity}/{item_id}/restore` در کدام دسته است (orphan/internal/deprecated) _(verify: manual_only)_
