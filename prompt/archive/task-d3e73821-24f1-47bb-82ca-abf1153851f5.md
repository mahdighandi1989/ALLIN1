---
task_id: d3e73821-24f1-47bb-82ca-abf1153851f5
title: بررسی و اقدام برای endpoint بلااستفاده GET /portfolio/export.pdf
type: audit
priority: medium
...
created_at: '2026-05-31T16:21:50.348312+00:00'
...
# بررسی و اقدام برای endpoint بلااستفاده GET /portfolio/export.pdf
...
---
[scan #2 at 2026-05-31T16:21:50.604558+00:00]
## 📋 شرح
endpoint `GET /portfolio/export.xlsx` در `backend/app/routers/reports.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.

## 🔍 جزئیات
- method: `GET`
- path: `/portfolio/export.xlsx`
- فایل: `backend/app/routers/reports.py`
...
1. مشخص شد endpoint `GET /portfolio/export.pdf` در کدام دسته است (orphan/internal/deprecated) _(verify: manual_only)_
