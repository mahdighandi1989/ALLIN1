---
task_id: c59f790f-8c02-40bc-b42e-bf1e610e89b1
title: 'تعیین تکلیف endpoint بلااستفاده: GET /customers/template'
type: audit
priority: medium
...
created_at: '2026-05-31T16:21:48.810571+00:00'
...
# تعیین تکلیف endpoint بلااستفاده: GET /customers/template
...
1. مشخص شد endpoint `GET /customers/template` در کدام دسته است (orphan/internal/deprecated) _(verify: manual_only)_
