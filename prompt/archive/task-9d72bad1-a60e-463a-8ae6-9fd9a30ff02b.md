---
task_id: 9d72bad1-a60e-463a-8ae6-9fd9a30ff02b
...
updated_at: '2026-06-05T15:51:05.348870+00:00'
archived: true
archived_at: '2026-06-05T15:51:05.348870+00:00'
tags:
- merged
target_files:
...
---
[scan #2 at 2026-05-31T16:20:31.868565+00:00]
An `ACCESS_TOKEN_EXPIRE_MINUTES` of 7 days (60 * 24 * 7) is excessively long for an access token. Access tokens should typically be short-lived (e.g., 15-60 minutes) to minimize the window of compromise if stolen. Long-lived sessions should be managed by refresh tokens.

📁 file: backend/app/config.p
