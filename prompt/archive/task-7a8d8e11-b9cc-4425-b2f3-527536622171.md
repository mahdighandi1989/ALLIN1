---
task_id: 7a8d8e11-b9cc-4425-b2f3-527536622171
title: Verify sort order in facility exports
type: bug
priority: medium
...
created_at: '2026-05-31T16:21:45.831733+00:00'
updated_at: '2026-06-05T20:54:38.182939+00:00'
archived: true
archived_at: '2026-06-05T20:54:38.182916+00:00'
---

# Verify sort order in facility exports

## Raw Idea

در خط 108-118، تابع exportFiltered پارامترهای فیلتر را به URLSearchParams اضافه می‌کند اما در خط 116، downloadFile را با `?${qs}` فراخوانی می‌کند. اگر qs خالی باشد (هیچ فیلتری فعال نباشد)، URL به صورت `/api/facilities/export.xlsx?` می‌شود که یک query string خالی دارد. این ممکن است باعث رفتار غیرمنتظره در backend شود. همچنین، پارامترهای sortBy و sortOrder در export لحاظ نشده‌اند.
...
frontend/src/app/facilities/page.tsx exportFiltered از URLSearchParams استفاده می‌کند اما downloadFile را با مسیر ناقص صدا می‌زند
...
1. اگر qs خالی است، از '?' استفاده نکنید. پارامترهای sortBy
