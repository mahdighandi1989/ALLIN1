---
task_id: c02381fe-c9bf-4974-8f6b-506c0c325ffb
title: 'Anti-pattern: Broken feedback loop / Stale assumption'
type: bug_fix
priority: high
...
created_at: '2026-06-07T16:55:02.695564+00:00'
updated_at: '2026-06-07T22:06:13.483313+00:00'
target_files:
- backend/app/routers/auth.py
---

# Anti-pattern: Broken feedback loop / Stale assumption

## Raw Idea

The `_log_login_attempt_to_redis` function writes login attempt data to Redis, with the stated purpose that this data 'can be used for cross-process rate limiting'. However, the provided code does not show any mechanism (e.g., within the `login_rate_limiter` utility or other parts of the authentication flow) that *reads* this Redis data to actually *enforce* cross-process rate limits. If the `logi

📁 file: backend/app/routers/auth.py (line 60)
...
- `backend/app/routers/auth.py:60`
