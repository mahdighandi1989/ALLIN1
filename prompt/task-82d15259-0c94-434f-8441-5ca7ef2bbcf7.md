...
updated_at: '2026-06-07T16:54:00.159423+00:00'
target_files:
- backend/.env.example
---
...
1. `backend/.env.example` contains `SECRET_KEY`, `DB_SSL_VERIFY`, and `AUTH_DISABLED`.
2. Comments explain the purpose and requirements for each variable, especially `SECRET_KEY`'s minimum length.
