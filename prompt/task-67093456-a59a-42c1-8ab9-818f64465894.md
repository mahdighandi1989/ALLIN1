...
updated_at: '2026-06-07T16:59:00.656657+00:00'
target_files:
...
1. git blame مشخص می‌کند چرا این دکمه `exportFiltered('xlsx')}
            className="flex items-center gap-1 px-3 py-2` فاقد handler است _(verify: static)_
...
3. اگر دکمه باقی ماند، تست end-to-end (Playwright یا cypress) برای کلیک و تأیید رفتار اضافه شده _(verify: static)_
