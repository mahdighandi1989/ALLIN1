---
task_id: a13ae0e8-48bd-45f7-b4c5-84144db25f7d
title: عدم وجود rate limiting روی endpoint‌های احراز هویت
type: security
priority: critical
...
created_at: '2026-05-31T16:18:52.830139+00:00'
updated_at: '2026-05-31T16:18:52.830142+00:00'
target_files:
- backend/app/main.py
---
...
1. endpoint /api/auth/login بعد از ۵ درخواست ناموفق در ۶۰ ثانیه ۴۲۹ Too Many Requests برگرداند
2. rate limiter از Redis استفاده کند (fallback به in-memory)
3. تست واحد برای rate limiting اضافه شود
