...
updated_at: '2026-06-07T16:58:26.106764+00:00'
target_files:
...
1. جستجو برای نام مشتری/تسهیلات با استفاده از کاراکترهای فارسی نتایج صحیح را برمی‌گرداند. _(verify: static)_
2. ورودی‌های جستجوی فرانت‌اند متن فارسی/عربی را به درستی نمایش داده و امکان ورود آن را فراهم می‌کنند. _(verify: static)_
3. هیچ خطای کدگذاری یا رفتار غیرمنتظره‌ای هنگام فیلتر کردن با رشته‌های یونیکد وجود ندارد. _(verify: static)_
