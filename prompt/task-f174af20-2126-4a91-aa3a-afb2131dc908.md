...
updated_at: '2026-06-07T16:58:59.559492+00:00'
target_files:
...
1. فرم ایجاد/ویرایش تسهیلات در صورت انتخاب `customer_id` غیرموجود، از ارسال جلوگیری می‌کند. _(verify: static)_
2. در صورت نامعتبر بودن `customer_id`، یک پیام خطای واضح به کاربر نمایش داده می‌شود. _(verify: static)_
3. API بک‌اند برای تسهیلات در صورت تلاش برای ایجاد/به‌روزرسانی تسهیلات با `customer_id` غیرموجود، یک خطای خاص (به عنوان مثال، 400 Bad Request یا 404 Not Found) را برمی‌گرداند. _(verify: static)_
