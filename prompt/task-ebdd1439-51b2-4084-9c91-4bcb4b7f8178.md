...
updated_at: '2026-06-07T16:57:56.566083+00:00'
target_files:
...
1. بررسی کنید که آیا `GET /api/facilities/search/advanced` عملکردی متمایز از `GET /api/facilities/` با پارامترهای کوئری ارائه می‌دهد. _(verify: static)_
...
4. اطمینان حاصل کنید که هیچ تست موجودی خراب نمی‌شود. _(verify: static)_
