...
updated_at: '2026-05-31T16:21:45.595111+00:00'
target_files:
...
1. بررسی شد `backend/app/utils/security.py` چه API ای از `backend/app/config.py` می‌خواهد
2. اگر API در `backend/app/config.py` نیست، اضافه شد
