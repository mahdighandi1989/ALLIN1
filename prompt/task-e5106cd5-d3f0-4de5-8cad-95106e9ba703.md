...
updated_at: '2026-05-31T16:20:28.728214+00:00'
target_files:
...
1. فایل `backend/tests/test_amortization.py` ایجاد شود و حداقل ۳ تست داشته باشد
2. فایل `backend/tests/test_excel_import.py` ایجاد شود و حداقل ۳ تست داشته باشد
3. فایل `backend/tests/test_exporters.py` ایجاد شود و حداقل ۳ تست داشته باشد
4. فایل `backend/tests
