---
task_id: 3ba913fd-e857-447e-b53c-e3230b889286
...
created_at: '2026-05-31T16:20:28.848146+00:00'
updated_at: '2026-05-31T16:20:28.848148+00:00'
target_files:
...
## 📋 شرح
در `backend/app/utils/security.py` (line 300) یک exception handler خاموش (مثل `except: pass`) در مسیر اصلی کد پیدا شد.
...
- `backend/app/utils/security.py:300`
...
- `backend/app/routers/settings.py` — `security.py` این فایل را import می‌کند
- `backend/app/database.py` — `security.py` این فایل را import می‌کند
- `backend/app/utils/token_blacklist.py` — `security.py` این فایل را import می‌کند
