...
updated_at: '2026-05-31T16:19:59.722111+00:00'
target_files:
- pyproject.toml
---
...
1. pyproject.toml دقیقاً bcrypt==4.0.1 را مشخص کند
2. نصب وابستگی‌ها با pip install -e . بدون خطا انجام شود
3. تابع hash_password در security.py بدون خطا کار کند
