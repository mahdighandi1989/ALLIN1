...
import { LayoutDashboard, Users, Building, FileText, BarChart3, ShieldCheck, Trash2, ScrollText, FileSpreadsheet, Settings, LogOut, BookOpen, Printer, Building2 } from 'lucide-react'
...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: '/properties', label: 'املاک رهنی', icon: Building2 },
      { href: '/offer-letters', label: 'Offer Letters', icon: FileText },
      { href: '/voucher', label: 'سند انتظامی', icon: Printer },
    ],
  },
  {
