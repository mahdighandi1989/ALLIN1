      ...
      <div className="cf-sheet">
        <div className="no-print cf-controls">
          ...
          <div style={{ flexBasis: '100%', fontSize: 11, color: '#64748b' }}>
            ستون آبیِ سمت راستِ هر ردیف تسهیلات (فقط روی صفحه) برای انتخاب تسهیلاتِ مشتری. در «Security» می‌توانید مشخص کنید هر سند برای کدام تسهیلات است. مبالغ خودکار کاما می‌گیرند. خانه‌های آبی قابل‌ویرایش‌اند؛ موقع پرینت پاک می‌شوند و خروجی خودکار فیت می‌شود (اگر یک‌صفحه‌ایِ خوانا نشد، تمام‌اندازه و چندصفحه‌ای چاپ می‌شود؛ با «حذف از پرینت» می‌توانی ردیف‌های ناخواسته/خالی را از خروجی برداری).
          </div>
