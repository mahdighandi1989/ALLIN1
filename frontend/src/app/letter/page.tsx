  ...
  const downloadWord = async () => {
    ...
    try {
      ...
      const blob = await buildLetterDocx({
        ...
        buildTag: 'reflow-v81',   // kept in lock-step with the visible marker by the release sed
      })
    ...
    <Layout>
      <div dir="rtl">
        ...
        <div className="ltr-controls no-print">
          ...
          <span className="ltr-hint" style={{ fontWeight: 700, color: '#16a34a', direction: 'ltr' }} title="نسخۀ کد — برای تأییدِ استقرار">build: reflow-v81</span>
        </div>
